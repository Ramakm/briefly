...
import { Calendar, Settings, User, LogOut, Bell } from "lucide-react"
...
const DashboardSidebar = ({ activeTab, setActiveTab, sidebarOpen, setSidebarOpen }: DashboardSidebarProps) => {
  ...
  const menuItems = [
    ...
    { id: "preferences", label: "Preferences", icon: Settings }, // Changed from Gear to Settings
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 h-full w-64 glass-card border-r z-50 transform transition-transform duration-300 ease-in-out ${
