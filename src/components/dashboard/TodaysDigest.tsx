...
const TodaysDigest = () => {
  const digestData = {
    email: {
      summary: "15 new emails today. Key highlights: 3 urgent client requests, 2 meeting invites for next week, and 5 newsletter updates.",
      items: [
          ...
          <Tabs defaultValue="email" className="w-full">
            ...
            <TabsContent value="email" className="mt-6">
              <div className="space-y-4">
                ...
                <div className="flex space-x-2 pt-4">
                  ...
                  <Button size="sm" variant="outline">Play Audio</Button>
                  ...
                  {digestData.slack.items.map((item, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-white/50 rounded-lg border border-white/20">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">{item.channel} • {item.author}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <TabsContent value="notion" className="mt-6">
              <div className="text-center py-8">
                ...
                <Button variant="outline" className="mt-4">Connect Notion</Button>
              </div>
            </TabsContent>
            ...
            <TabsContent value="zoom" className="mt-6">
              <div className="text-center py-8">
                ...
                <Button variant="outline" className="mt-4">Connect Zoom</Button>
              </div>
            </TabsContent>
          </Tabs>
        </CardContent>
